...
srun singularity run cfm-4/cfm.simg -c "cfm-predict $FILE 0.001 /trained_models_cfmid4.0/[M+H]+/param_output.log /trained_models_cfmid4.0/[M+H]+/param_config.txt 1" > ${FILE_INDEX}.txt